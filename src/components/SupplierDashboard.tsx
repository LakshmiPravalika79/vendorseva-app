...
import { collection, addDoc, query, where, onSnapshot, orderBy, doc, updateDoc, QuerySnapshot, QueryDocumentSnapshot } from 'firebase/firestore';
  ...
  const handleAddProduct = async (e: React.FormEvent) => {
    ...
    try {
      await addDoc(collection(db, 'products'), {
        supplierId: user.uid, supplierName: user.displayName || user.email, name: productName, pricePerUnit: Number(price), unit: unit, imageUrl: imageUrl, status: 'available', createdAt: new Date(),
      });
